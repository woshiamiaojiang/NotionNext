const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-10-19', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.saika.tech' },
    { title: '访问文档中心获取更多帮助', url: 'https://docs.saika.tech' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'SAIKA.COM',
  // HERO_TITLE_4: '新版上线',
  // HERO_TITLE_5: 'NotionNext4.0 轻松定制主题',
  // HERO_TITLE_LINK: 'https://www.saika.com',
  ...
  SOCIAL_CARD_URL: 'https://docs.saika.com/article/how-to-question',
